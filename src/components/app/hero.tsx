...
export function Hero() {
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-black text-white flex items-center justify-center overflow-hidden relative">
      <FloatingElement delay={0.6}>
        <div className="w-16 h-16 bg-blue-500 rounded-full opacity-20 absolute -top-8 -left-8" />
      </FloatingElement>
      <FloatingElement delay={0.8}>
        <div className="w-24 h-24 bg-green-500 rounded-full opacity-20 absolute top-1/4 -right-12" />
      </FloatingElement>
      <FloatingElement delay={1}>
        <div className="w-20 h-20 bg-purple-500 rounded-full opacity-20 absolute bottom-1/4 -left-10" />
      </FloatingElement>
